-- Automatic partitioning of table WRK_SALES:
CREATE OR REPLACE FUNCTION "BL_CL".fnc_create_partitions_for_wrk_sales(
...
BEGIN
    ...
    LOOP
        ...
        LOOP
            ...
            EXECUTE FORMAT('CREATE TABLE IF NOT EXISTS "BL_CL"."WRK_SALES_%s_Q%s"
                            PARTITION OF "BL_CL"."WRK_SALES"
