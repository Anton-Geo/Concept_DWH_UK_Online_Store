-- Automatic partitioning of table FCT_SALES_DD:
CREATE OR REPLACE FUNCTION "BL_CL".fnc_create_partitions_for_fct_sales_dd(
...
BEGIN
    ...
    LOOP
        ...
        LOOP
            ...
            EXECUTE FORMAT('CREATE TABLE IF NOT EXISTS "BL_DM"."FCT_SALES_DD_%s_Q%s"
